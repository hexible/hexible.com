...
export const Hero = ({ ...rest }: React.ComponentProps<"main">) => {
  return (
    <main
      className="justify-between items-center grid grid-cols-1 lg:grid-cols-3 mt-16 md:mt-20 h-full"
      {...rest}
    >
      <div className="space-y-5 lg:col-span-2">
        <h1 className="font-extrabold text-3xl md:text-5xl text-center lg:text-start leading-tight">
          {AppData.taglinePart1}, <br /> {AppData.taglinePart2}
        </h1>
        <h2 className="my-4 text-center lg:text-start">
