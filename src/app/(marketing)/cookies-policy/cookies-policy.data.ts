export const CookiesPolicyData = {
  ...
  sections: [
    ...
    },
    {
      ...
      content:
        "We use both session cookies and persistent cookies on our website. Session cookies are temporary and are deleted when you close your browser. Persistent cookies remain on your device until they expire or you delete them. We also use third-party cookies to collect information about your browsing habits and to provide personalized advertising. These cookies are placed by third-party advertisers who work with us to serve ads on our website or on other websites.",
    },
    {
    ...
    {
      title: "Changes to Cookies Policy",
      content:
    ...
    },
    {
      title: "Contact Us",
      content:
        "If you have any questions or concerns about this Cookies Policy, please contact us at privacy@hexible.com.",
    },
  ],
};
